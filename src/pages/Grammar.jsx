...
export function Grammar() {
  ...
  return (
    <PageShell back wide eyebrow="Grammaire" title="Des leçons courtes, des exercices immédiats" sub="Chaque sujet se termine par des exercices corrigés. Dix minutes par leçon, pas plus.">
