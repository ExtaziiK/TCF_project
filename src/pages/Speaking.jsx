...
function SpeakingStudio() {
  const { t } = useApp();
  return (
    <PageShell back eyebrow={t("Expression orale")} title={t("Parlez, réécoutez-vous, progressez")} sub={t("Enregistrez votre réponse : elle est transcrite par Whisper puis évaluée par l'IA (pertinence, vocabulaire, grammaire, fluidité).")}>
      <SpeakingStudioBody />
    </PageShell>
  );
}
