  ...
  return (
    <div className="grid lg:grid-cols-3 gap-5 rise">
      <div className="lg:col-span-2 space-y-5">
        ...
        {ai && <AiFeedback level={ai.level} score={ai.score} nclc={ai.nclc} summary={ai.summary} strengths={ai.strengths} improvements={ai.improvements} corrected={ai.corrected} targetLevel={ai.targetLevel} rewrites={ai.rewrites} />}
      </div>
