...
export const PLANS = [
  ...
  },
  {
    ...
    feats: [
      ...
      "Correction IA de l'écrit et de l'oral",
      "Vocabulaire et grammaire complets",
  ...
  },
  {
    ...
    feats: [
      ...
      "Entretien oral simulé avec l'examinateur IA",
      "Correction IA détaillée de l'écrit et de l'oral",
      "Statistiques détaillées et signets",
  ...
  },
  {
    ...
    feats: [
      ...
      "Entretien oral simulé avec l'examinateur IA",
      "Correction IA détaillée de l'écrit et de l'oral",
      "Tableau de bord et statistiques complets",
      "90 jours d'accès — meilleure valeur",
