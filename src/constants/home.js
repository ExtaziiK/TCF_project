...
export const TESTIMONIALS = [
  { name: "Abir B.", from: "Casablanca → Montréal", level: "C1 obtenu", text: "En 8 semaines, je suis passée de B1 à C1 en compréhension orale. Les TCF blancs m'ont enlevé tout le stress le jour J." },
