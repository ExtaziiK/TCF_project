...
export function Footer() {
  ...
  const cols = [
    ...
    { h: "Ressources", links: [["Guide de l'examen", "guide"], ["Calculateur TCF → NCLC", "calculator"], ["Sujets d'actualité", "sujets-actualite"], ["Vocabulaire", "vocabulary"], ["Grammaire", "grammar"], ["Blog", "blog"], ["FAQ", "faq"]] },
