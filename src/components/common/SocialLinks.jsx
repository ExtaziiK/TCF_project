...
// The four brand marks, drawn here rather than taken from lucide. lucide has no
// TikTok or WhatsApp glyph at all, and its YouTube and Facebook icons are
// outlined line-art in the house style — recognisable, but not the logos. A
// follow row is one of the few places where the real mark in the real colour is
// the point: people scan for the shape and the colour together, not for a
// tidy outline.
//
// Each mark carries its own fill, so callers do not colour them. The one
// exception is TikTok, whose logo is three offset copies of the same glyph —
// cyan and magenta behind, and a body that is black on light and white on dark.
// That last layer is the reason this file reads the theme; the wider viewBox
// gives the two offsets room so nothing clips at the edges.
...
export const SOCIAL_ICON = { youtube: YouTube, tiktok: TikTok, facebook: Facebook, whatsapp: WhatsApp };
